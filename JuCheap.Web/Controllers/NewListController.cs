...
{
    public class NewListController : BaseController
    {
        private readonly INewsService  _newService;
        private readonly IMapper _mapper;

        // GET: SinglePageculturecontact
        public NewListController(INewsService newService, IMapper mapper)
        {
